...
function VocationalTestCard() {
  ...
  return /* @__PURE__ */ jsx(
    "a",
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "clip-card w-full h-full flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 px-4 md:px-8 py-4 bg-[radial-gradient(ellipse_at_50%_50%,#1e1b2e_0%,#0a0a0a_100%)] hover:bg-[radial-gradient(ellipse_at_50%_50%,#2d1b38_0%,#0a0a0a_100%)] transition", children: [
