...
import { i as analytics, m as motion, L as LogoH } from "../../main.mjs";
import { Helmet } from "@dr.pogodin/react-helmet";
import { Trophy, User, Pulse, Target, Brain, CaretRight, Star, ChatCircle, Clock, ChartBar, Lightbulb, MapPin, Check, CaretLeft, BookOpen, Palette, Code, TrendUp, Camera, Users, ChartPie, Phone, ArrowsClockwise, DownloadSimple, ShareNetwork } from "@phosphor-icons/react";
        ...
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
              /* @__PURE__ */ jsx("div", { className: "w-16 h-16 bg-[#d400ff]/20 rounded-full flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsx(ChartBar, { className: "text-[#d400ff]", size: 32 }) }),
              /* @__PURE__ */ jsx("h3", { className: "text-white font-semibold text-lg mb-2", children: "Análise Completa" }),
              /* @__PURE__ */ jsx("p", { className: "text-gray-300", children: "Dashboard detalhado com suas afinidades profissionais" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
              /* @__PURE__ */ jsx("div", { className: "w-16 h-16 bg-[#d400ff]/20 rounded-full flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsx(Lightbulb, { className: "text-[#d400ff]", size: 32 }) }),
              /* @__PURE__ */ jsx("h3", { className: "text-white font-semibold text-lg mb-2", children: "Recomendação Inteligente" }),
              /* @__PURE__ */ jsx("p", { className: "text-gray-300", children: "Cursos selecionados especificamente para você" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
              /* @__PURE__ */ jsx("div", { className: "w-16 h-16 bg-[#d400ff]/20 rounded-full flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsx(MapPin, { className: "text-[#d400ff]", size: 32 }) }),
              /* @__PURE__ */ jsx("h3", { className: "text-white font-semibold text-lg mb-2", children: "Cursos Locais" }),
              /* @__PURE__ */ jsx("p", { className: "text-gray-300", children: "Aulas presenciais na Grande Florianópolis" })
            ] })
          ]
        }
      )
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gray-50", children: [
      ...
      /* @__PURE__ */ jsxs("main", { className: currentStep === "intro" ? "pt-0" : "pt-20", children: [
        currentStep === "intro" && /* @__PURE__ */ jsx(
          motion.section,
          {
            id: "teste",
            ...
            children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("div", { className: "text-center mb-8", children: /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2 bg-gradient-to-r from-purple-100 to-blue-100 px-6 py-3 rounded-full mb-6", children: [
                    /* @__PURE__ */ jsx(Trophy, { className: "text-[#d400ff]", size: 20 }),
                    /* @__PURE__ */ jsx("span", { className: "text-[#d400ff] font-bold text-sm uppercase tracking-wide", children: "Metodologia MIT • Harvard • Stanford" })
                  ] }) }),
                  /* @__PURE__ */ jsx("h2", { className: "text-4xl font-bold text-gray-900 mb-6", children: "Teste Vocacional Científico - Como Funciona?" }),
                  /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-3 gap-8 mb-12", children: [
                    /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
                      /* @__PURE__ */ jsx("div", { className: "w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsx(User, { className: "text-[#d400ff]", size: 32 }) }),
                      /* @__PURE__ */ jsx("h3", { className: "text-xl font-semibold text-gray-900 mb-2", children: "1. Responda" }),
                      /* @__PURE__ */ jsx("p", { className: "text-gray-600", children: "15 perguntas científicas baseadas no modelo VIPS (Valores, Interesses, Personalidade, Habilidades)" })
                    ] }),
                    /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
                      /* @__PURE__ */ jsx("div", { className: "w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsx(Pulse, { className: "text-[#d400ff]", size: 32 }) }),
                      /* @__PURE__ */ jsx("h3", { className: "text-xl font-semibold text-gray-900 mb-2", children: "2. Analisamos" }),
                      /* @__PURE__ */ jsx("p", { className: "text-gray-600", children: "Análise baseada no modelo Holland RIASEC validado por universidades mundiais" })
                    ] }),
                    /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
                      /* @__PURE__ */ jsx("div", { className: "w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsx(Target, { className: "text-[#d400ff]", size: 32 }) }),
                      /* @__PURE__ */ jsx("h3", { className: "text-xl font-semibold text-gray-900 mb-2", children: "3. Recomendamos" }),
                      /* @__PURE__ */ jsx("p", { className: "text-gray-600", children: "Cursos personalizados com base no seu resultado" })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxs(
                    motion.button,
