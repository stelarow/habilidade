...
import { MessageCircle, ArrowLeft, GraduationCap, CalendarCheck, MapPin, Box, Lightbulb, Target, Camera, AlertCircle, CheckCircle, Timer, ExternalLink, Phone, ChevronDown, Clock } from "lucide-react";
const CourseHeader = () => {
  ...
  return /* @__PURE__ */ jsx(
    motion.header,
    {
      ...
      children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 py-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsxs(
            motion.a,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("span", { children: "Voltar" })
              ]
            }
          ),
          /* @__PURE__ */ jsx(
...
const CourseHero = () => {
  return /* @__PURE__ */ jsxs("section", { className: "relative min-h-screen flex items-center justify-center overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "relative z-10 container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-center", children: [
      /* @__PURE__ */ jsxs(
        motion.div,
        {
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-3 gap-8 mb-16", children: [
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          transition: { duration: 0.6 },
          children: [
            /* @__PURE__ */ jsx("div", { className: "w-16 h-16 bg-purple-600 rounded-full flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsx(Box, { className: "text-white", size: 32 }) }),
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
              ...
              /* @__PURE__ */ jsx(
                motion.div,
                {
                  ...
                  children: /* @__PURE__ */ jsx(ChevronDown, { className: "text-gray-400", size: 24 })
                }
              )
            ] })
          }
...
const Curriculum = () => {
  ...
  return /* @__PURE__ */ jsx("section", { className: "py-20 bg-gradient-to-br from-purple-900 to-black", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
    /* @__PURE__ */ jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 50 },
  ...
  return /* @__PURE__ */ jsx("section", { className: "py-20 bg-white", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4", children: [
    /* @__PURE__ */ jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("h2", { className: "text-4xl md:text-5xl font-bold text-gray-900 mb-6", children: [
            "Empresas regionais que fizeram nosso curso de ",
            /* @__PURE__ */ jsx("span", { className: "text-purple-600", children: "projetista" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-xl text-gray-700 max-w-3xl mx-auto", children: "Empresas da região que confiaram na Escola Habilidade para capacitar seus profissionais em projetos" })
        ]
      }
    ),
    /* @__PURE__ */ jsxs("div", { className: "relative overflow-hidden max-w-7xl mx-auto", children: [
          ...
          children: [
            companies.map((company, index) => /* @__PURE__ */ jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("div", { className: "w-20 h-20 flex items-center justify-center mb-4 rounded-lg bg-white shadow-sm group-hover:shadow-md transition-shadow", children: /* @__PURE__ */ jsx(
                    "img",
                    {
                      src: company.logo,
                      alt: company.name,
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
                    /* @__PURE__ */ jsx("h3", { className: "font-semibold text-gray-900 text-sm mb-1", children: company.name }),
                    /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-600", children: company.description })
                  ] })
                ]
              },
              `first-${index}`
      ...
      /* @__PURE__ */ jsx("div", { className: "absolute left-0 top-0 bottom-0 w-20 bg-gradient-to-r from-white to-transparent z-10 pointer-events-none" }),
      /* @__PURE__ */ jsx("div", { className: "absolute right-0 top-0 bottom-0 w-20 bg-gradient-to-l from-white to-transparent z-10 pointer-events-none" })
    ] }),
    /* @__PURE__ */ jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsx("div", { className: "text-3xl font-bold text-purple-600 mb-2", children: "50+" }),
            /* @__PURE__ */ jsx("div", { className: "text-gray-600", children: "Empresas Atendidas" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsx("div", { className: "text-3xl font-bold text-purple-600 mb-2", children: "200+" }),
            /* @__PURE__ */ jsx("div", { className: "text-gray-600", children: "Projetos Entregues" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsx("div", { className: "text-3xl font-bold text-purple-600 mb-2", children: "95%" }),
            /* @__PURE__ */ jsx("div", { className: "text-gray-600", children: "Taxa de Aprovação" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsx("div", { className: "text-3xl font-bold text-purple-600 mb-2", children: "4.9★" }),
            /* @__PURE__ */ jsx("div", { className: "text-gray-600", children: "Avaliação Média" })
          ] })
        ]
      }
    )
      ...
      motion.div,
      {
        ...
        children: [
              ...
              children: [
                /* @__PURE__ */ jsx(
                  motion.div,
                  {
                    ...
                    transition: { duration: 2, repeat: Infinity },
                    children: /* @__PURE__ */ jsx(AlertCircle, { size: 20, className: "text-purple-400" })
                  }
                ),
          ...
          /* @__PURE__ */ jsxs("p", { className: "text-xl text-gray-200 mb-4 max-w-3xl mx-auto", children: [
            /* @__PURE__ */ jsx("span", { className: "line-through text-gray-400 text-lg", children: "De R$ 4.999,00" }),
            /* @__PURE__ */ jsx("br", {}),
            /* @__PURE__ */ jsx("strong", { className: "text-3xl text-white", children: "Por apenas R$ 3.999,00 à vista" }),
            /* @__PURE__ */ jsx("br", {}),
            /* @__PURE__ */ jsxs("span", { className: "text-xl", children: [
              "ou ",
              /* @__PURE__ */ jsx("strong", { className: "text-green-400", children: "10x de R$ 399,90" }),
              " sem juros"
            ] })
          ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "relative z-30 bg-white rounded-xl p-6 shadow-lg", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "text-xl font-bold text-gray-900", children: "(48) 98458-7067" })
              ] }),
              /* @__PURE__ */ jsxs(
                motion.a,
                {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "font-sans min-h-screen", children: [
    ...
    /* @__PURE__ */ jsx(
      motion.a,
      {
        ...
        children: /* @__PURE__ */ jsx(MessageCircle, { className: "text-white", size: 24 })
      }
    )
  ] });
};
