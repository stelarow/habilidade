...
import { CheckCircle, Star, House, CaretRight, GraduationCap, CaretUp, CaretDown, Quotes, Target, Buildings, ChatCircle, Check, Phone, Envelope, User, PaperPlaneTilt, Briefcase, ArrowRight, Lightning, Trophy, Crown, Wrench, Users, TrendUp, BookOpen, Eye, PencilLine, MapPin, Play, Lightbulb } from "@phosphor-icons/react";
import emailjs from "@emailjs/browser";
import { E as ErrorBoundary, G as GradientButton, L as Loading } from "../main.mjs";
import { k as usePerformanceLevel, v as useViewportSize, w as getLessonLabel, x as getLessonIconByArea, y as generateCourseMetadata, i as getCourseBySlug, z as validateAndSanitizeCourse, A as isEmailConfigured, E as EMAIL_CONFIG } from "./utils-CtCVPYGt.js";
import PropTypes from "prop-types";
import { C as COURSES_DATA } from "./blog-components-63qilnam.js";
...
const backgrounds = {
  "inteligencia-artificial": lazy(
    () => import("./backgrounds-BFYvDaJ7.js").then((n) => n.b).then((module) => ({ default: module.default }))
  ),
  "design-grafico": lazy(
    () => import("./backgrounds-BFYvDaJ7.js").then((n) => n.D).then((module) => ({ default: module.default }))
  ),
  "informatica": lazy(
    () => import("./backgrounds-BFYvDaJ7.js").then((n) => n.I).then((module) => ({ default: module.default }))
  ),
  "programacao": lazy(
    () => import("./backgrounds-BFYvDaJ7.js").then((n) => n.a).then((module) => ({ default: module.default }))
  ),
  "marketing-digital": lazy(
    () => import("./backgrounds-BFYvDaJ7.js").then((n) => n.M).then((module) => ({ default: module.default }))
  ),
  "business-intelligence": lazy(
    () => import("./backgrounds-BFYvDaJ7.js").then((n) => n.B).then((module) => ({ default: module.default }))
  ),
  "edicao-video": lazy(
    () => import("./backgrounds-BFYvDaJ7.js").then((n) => n.E).then((module) => ({ default: module.default }))
  ),
  "projetista-3d": lazy(
    () => import("./backgrounds-BFYvDaJ7.js").then((n) => n.P).then((module) => ({ default: module.default }))
  ),
  "administracao": lazy(
    () => import("./backgrounds-BFYvDaJ7.js").then((n) => n.A).then((module) => ({ default: module.default }))
  )
...
const CourseProblemStatement = ({ course }) => {
  ...
  return /* @__PURE__ */ jsx("section", { className: "py-20", children: /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxs("div", { className: "text-center mb-16", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-3xl sm:text-4xl font-bold text-white mb-6", children: "Problemas que Todo Projetista 3D Enfrenta" }),
      /* @__PURE__ */ jsx("p", { className: "text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed", children: "Você está perdendo projetos e clientes porque ainda não domina o workflow completo do profissional 3D moderno: do desenho técnico até renderizações fotorrealísticas instantâneas." })
    ] }),
    ...
    /* @__PURE__ */ jsx("div", { className: "text-center", children: /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("span", { className: "text-lg text-white font-medium", children: "A solução? Domine SketchUp + AutoCAD + Revit + Enscape com IA em um curso só" }),
          /* @__PURE__ */ jsx(
            ArrowRight,
            {
              size: 20,
