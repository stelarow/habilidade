...
class BackgroundPreloader {
  ...
  async loadBackgroundComponent(courseSlug, deviceCapabilities) {
    const componentMap = {
      [COURSE_SLUGS.PROJETISTA_3D]: () => import("./backgrounds-CVGEKd_2.js").then((n) => n.P),
      [COURSE_SLUGS.EDICAO_VIDEO]: () => import("./backgrounds-CVGEKd_2.js").then((n) => n.E),
      [COURSE_SLUGS.INFORMATICA]: () => import("./backgrounds-CVGEKd_2.js").then((n) => n.I),
      [COURSE_SLUGS.DESIGN_GRAFICO]: () => import("./backgrounds-CVGEKd_2.js").then((n) => n.D),
      [COURSE_SLUGS.PROGRAMACAO]: () => import("./backgrounds-CVGEKd_2.js").then((n) => n.a),
      [COURSE_SLUGS.MARKETING_DIGITAL]: () => import("./backgrounds-CVGEKd_2.js").then((n) => n.M),
      [COURSE_SLUGS.INTELIGENCIA_ARTIFICIAL]: () => import("./backgrounds-CVGEKd_2.js").then((n) => n.b),
      [COURSE_SLUGS.BUSINESS_INTELLIGENCE]: () => import("./backgrounds-CVGEKd_2.js").then((n) => n.B)
    };
