...
import { f as usePageContext, h as useSmartCTA, s as searchCourses, i as getCourseBySlug, j as useToggle, k as usePerformanceLevel, l as useGoogleAnalytics, n as useUrlCleanup, o as useScrollToHash, p as domOptimizer } from "./assets/utils-D0CRhHwP.js";
import { C as COURSES_DATA } from "./assets/blog-components-BV6c3eIl.js";
...
React.lazy(() => import("./assets/Home-B3E9V15M.js"));
React.lazy(() => import("./assets/CoursePage-8uqPJ_hw.js"));
const Contact = React.lazy(() => import("./assets/Contact-DfZje2AL.js"));
React.lazy(() => import("./assets/BlogIndex-BD5ow4Rc.js"));
React.lazy(() => import("./assets/BlogTestPage-B3MlFaXT.js"));
React.lazy(() => import("./assets/BlogCategory-CM8B7Om_.js"));
React.lazy(() => import("./assets/NotFound-wSBhes32.js"));
const CursosFlorianopolis = React.lazy(() => import("./assets/CursosFlorianopolis-YFhHbVNF.js"));
const CursosSaoJose = React.lazy(() => import("./assets/CursosSaoJose-pE3u_PDe.js"));
const CursosPalhoca = React.lazy(() => import("./assets/CursosPalhoca-CKqZN-da.js"));
const CursoSketchupEnscape = React.lazy(() => import("./assets/CursoSketchupEnscape-D5cHqJAI.js"));
...
const routes = [
  ...
  },
  {
    ...
    children: [
      {
        index: true,
        lazy: () => import("./assets/Home-B3E9V15M.js")
      },
      {
        path: "cursos/:courseSlug",
        lazy: () => import("./assets/CoursePage-8uqPJ_hw.js")
      },
      {
        path: "contato",
      ...
      },
      {
        ...
        children: [
          {
            index: true,
            lazy: () => import("./assets/BlogIndex-BD5ow4Rc.js")
          },
          {
            path: "categoria/:categorySlug",
            lazy: () => import("./assets/BlogCategory-CM8B7Om_.js")
          },
          {
            path: ":slug",
            lazy: () => import("./assets/BlogPostSSG-CS_7yM8d.js"),
      ...
      },
      {
        ...
        children: [
          {
            index: true,
            lazy: () => import("./assets/BlogTestPage-B3MlFaXT.js")
          },
          {
            path: ":slug",
            lazy: () => import("./assets/BlogTestPage-B3MlFaXT.js")
