...
import { c as BlogError, g as Breadcrumbs, L as LazyImage, i as ShareButtons, j as BlogCTA, T as TableOfContents } from "./blog-components-BV6c3eIl.js";
import { F as useContactAnalytics, G as generateWhatsAppMessage, H as processContent, I as extractPlainText } from "./utils-D0CRhHwP.js";
...
function BlogPost() {
  ...
  const seoImage = ((_b = post.featuredImage) == null ? void 0 : _b.url) || post.imageUrl || "https://www.escolahabilidade.com/assets/logos/original/logo-original.png";
          ...
          /* @__PURE__ */ jsxs("article", { className: "lg:col-span-3 order-2 lg:order-1", children: [
            /* @__PURE__ */ jsxs("div", { className: "bg-zinc-900/50 backdrop-blur-sm rounded-2xl border border-zinc-800 p-8 shadow-2xl", children: [
              /* @__PURE__ */ jsxs("header", { className: "mb-8", children: [
                ...
                (((_i = post.featuredImage) == null ? void 0 : _i.url) || post.imageUrl) && /* @__PURE__ */ jsx("div", { className: "mt-8 rounded-xl overflow-hidden", children: /* @__PURE__ */ jsx(
                  LazyImage,
                  {
