...
import { k as usePerformanceLevel, v as useViewportSize, w as getLessonLabel, x as getLessonIconByArea, y as generateCourseMetadata, i as getCourseBySlug, z as validateAndSanitizeCourse, A as isEmailConfigured, E as EMAIL_CONFIG } from "./utils-D0CRhHwP.js";
import PropTypes from "prop-types";
import { C as COURSES_DATA } from "./blog-components-BV6c3eIl.js";
...
const backgrounds = {
  "inteligencia-artificial": lazy(
    () => import("./backgrounds-Cnn5dnKm.js").then((n) => n.b).then((module) => ({ default: module.default }))
  ),
  "design-grafico": lazy(
    () => import("./backgrounds-Cnn5dnKm.js").then((n) => n.D).then((module) => ({ default: module.default }))
  ),
  "informatica": lazy(
    () => import("./backgrounds-Cnn5dnKm.js").then((n) => n.I).then((module) => ({ default: module.default }))
  ),
  "programacao": lazy(
    () => import("./backgrounds-Cnn5dnKm.js").then((n) => n.a).then((module) => ({ default: module.default }))
  ),
  "marketing-digital": lazy(
    () => import("./backgrounds-Cnn5dnKm.js").then((n) => n.M).then((module) => ({ default: module.default }))
  ),
  "business-intelligence": lazy(
    () => import("./backgrounds-Cnn5dnKm.js").then((n) => n.B).then((module) => ({ default: module.default }))
  ),
  "edicao-video": lazy(
    () => import("./backgrounds-Cnn5dnKm.js").then((n) => n.E).then((module) => ({ default: module.default }))
  ),
  "projetista-3d": lazy(
    () => import("./backgrounds-Cnn5dnKm.js").then((n) => n.P).then((module) => ({ default: module.default }))
  ),
  "administracao": lazy(
    () => import("./backgrounds-Cnn5dnKm.js").then((n) => n.A).then((module) => ({ default: module.default }))
  )
