...
export function MaintenanceMode({ 
  ...
  const whatsappMessage = encodeURIComponent(
    `Ol�! Estou tentando acessar a plataforma Habilidade mas est� em manuten��o. Preciso de suporte urgente. Manuten��o: ${maintenance.title}`
  );
            ...
            <CardContent className="space-y-6">
              ...
              <div className="text-center">
                ...
                <p className="text-blue-200 mt-4">
                  Previs�o de conclus�o: {format(maintenance.endTime, "dd/MM/yyyy '�s' HH:mm", { locale: ptBR })}
                </p>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-blue-200 text-sm">
                  Nossa equipe estar� dispon�vel para emerg�ncias
                </p>
              </div>

              {/* Social Links */}
              <div className="text-center pt-4 border-t border-white/20">
                <p className="text-blue-200 mb-3">Acompanhe nossas atualiza��es:</p>
                <div className="flex justify-center gap-4">
                  <Button
                    asChild
                    variant="ghost"
