...
// Video Components (Placeholder for Fase 2)
export { VideoPlayer } from './video/VideoPlayer'

// PDF Components (Placeholder for Fase 2)
export { PDFViewer } from './pdf/PDFViewer'

// Quiz Components (Placeholder for Fase 2)
export { QuizInterface } from './quiz/QuizInterface'

// Exercise Components (Placeholder for Fase 2)
export { ExercisePanel } from './exercises/ExercisePanel'

// Progress Components (Implemented in Fase 2)
