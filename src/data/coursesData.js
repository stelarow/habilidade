  ...
  curriculum: [
    {
      ...
      lessons: [
        ...
        { id: 17, title: 'Projeto arquitetônico - Planta baixa', duration: '90 min', type: 'project' },
        { id: 18, title: 'Projeto arquitetônico - Cortes e fachadas', duration: '90 min', type: 'project' },
        { id: 19, title: 'Detalhamento técnico e executivo', duration: '90 min', type: 'project' },
        { id: 20, title: 'Portfolio: Projeto técnico completo', duration: '90 min', type: 'project' },
      ],
    },
    {
      id: 2,
      ...
      lessons: [
        { id: 21, title: 'Interface e navegação 3D', duration: '90 min', type: 'video' },
        { id: 22, title: 'Ferramentas básicas de modelagem', duration: '90 min', type: 'video' },
        { id: 23, title: 'Criação de formas complexas', duration: '90 min', type: 'video' },
        { id: 24, title: 'Grupos e componentes', duration: '90 min', type:'video' },
        { id: 25, title: 'Materiais e texturas', duration: '90 min', type: 'video' },
        { id: 26, title: 'Importação de plantas 2D', duration: '90 min', type: 'video' },
        { id: 27, title: 'Modelagem arquitetônica - Estrutura', duration: '90 min', type: 'video' },
        { id: 28, title: 'Modelagem arquitetônica - Detalhes', duration: '90 min', type: 'video' },
        { id: 29, title: 'Biblioteca 3D Warehouse', duration: '90 min', type: 'video' },
        { id: 30, title: 'Scenes e animação', duration: '90 min', type: 'video' },
        { id: 31, title: 'Layout e apresentação 2D', duration: '90 min', type: 'video' },
        { id: 32, title: 'Extensões e plugins essenciais', duration: '90 min', type: 'video' },
        { id: 33, title: 'Modelagem de terreno e topografia', duration: '90 min', type: 'video' },
        { id: 34, title: 'Projeto residencial completo', duration: '90 min', type: 'project' },
        { id: 35, title: 'Projeto comercial 3D', duration: '90 min', type: 'project' },
        { id: 36, title: 'Portfolio: Apresentação arquitetônica', duration: '90 min', type: 'project' },
      ],
    },
    {
      id: 3,
      ...
      lessons: [
        { id: 37, title: 'Configuração do V-Ray no SketchUp', duration: '90 min', type: 'video' },
        { id: 38, title: 'Materiais V-Ray básicos', duration: '90 min', type: 'video' },
        { id: 39, title: 'Iluminação natural e artificial', duration: '90 min', type: 'video' },
        { id: 40, title: 'Configurações de render', duration: '90 min', type: 'video' },
        { id: 41, title: 'Câmeras e composição', duration: '90 min', type: 'video' },
        { id: 42, title: 'Materiais avançados (vidro, metal, madeira)', duration: '90 min', type: 'video' },
        { id: 43, title: 'Ambiente externo e HDRI', duration: '90 min', type: 'video' },
        { id: 44, title: 'Pós-produção básica', duration: '90 min', type: 'video' },
        { id: 45, title: 'Render de interiores fotorrealístico', duration: '90 min', type: 'project' },
        { id: 46, title: 'Render de fachada profissional', duration: '90 min', type: 'project' },
      ],
    },
    {
      id: 4,
      ...
      lessons: [
        { id: 47, title: 'Introdução ao Enscape e integração SketchUp', duration: '120 min', type: 'video' },
        { id: 48, title: 'Renderização em tempo real', duration: '120 min', type: 'video' },
        { id: 49, title: 'Materiais inteligentes e biblioteca IA', duration: '120 min', type: 'video' },
        { id: 50, title: 'Iluminação automática com IA', duration: '120 min', type: 'video' },
        { id: 51, title: 'Realidade Virtual (VR) para clientes', duration: '120 min', type: 'video' },
        { id: 52, title: 'Panoramas 360° interativos', duration: '120 min', type: 'video' },
        { id: 53, title: 'Videos e animações automáticas', duration: '120 min', type: 'video' },
        { id: 54, title: 'Vegetação e paisagismo com IA', duration: '120 min', type: 'video' },
        { id: 55, title: 'Ambientação automática de interiores', duration: '120 min', type: 'video' },
        { id: 56, title: 'Configurações avançadas de qualidade', duration: '120 min', type: 'video' },
        { id: 57, title: 'Integração com nuvem e compartilhamento', duration: '120 min', type: 'video' },
        { id: 58, title: 'Projeto Final: Apresentação VR completa', duration: '120 min', type: 'project' },
      ],
    }
  ],
  whatYouWillLearn: [
