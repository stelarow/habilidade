...
const marketingDigital = {
  ...
  curriculum: [
    ...
    },
    {
      ...
      description: 'Aplicações práticas de IA para criação, planejamento e otimização de campanhas',
      duration: '6 horas',
      note: 'Conteúdo provisório para apresentação da estrutura do módulo em produção',
      lessons: [
        { id: 27, title: 'Introdução à IA aplicada ao Marketing', duration: '90 min', type: 'video' },
        { id: 28, title: 'Ferramentas de IA para criação de conteúdo', duration: '90 min', type: 'video' },
        { id: 29, title: 'Planejamento de campanhas com apoio de IA', duration: '90 min', type: 'video' },
        { id: 30, title: 'Automação e otimização de resultados com IA', duration: '90 min', type: 'video' },
      ],
    },
    {
      id: 5,
      ...
      duration: '3 horas',
      lessons: [
        { id: 31, title: 'Marketing Pessoal – Valores e Auto-Conhecimento', duration: '90 min', type: 'video' },
        { id: 32, title: 'Networking, Branding e Qualificação Profissional', duration: '90 min', type: 'video' },
      ],
    },
    {
      id: 6,
      ...
      duration: '24 horas',
      lessons: [
        { id: 33, title: 'Conhecendo o Facebook Business', duration: '90 min', type: 'video' },
        { id: 34, title: 'Criando Conta de Usuário e Página', duration: '90 min', type: 'video' },
        { id: 35, title: 'Menu Configurações I', duration: '90 min', type: 'video' },
        { id: 36, title: 'Menu Configurações II', duration: '90 min', type: 'video' },
        { id: 37, title: 'Menu Configurações III', duration: '90 min', type: 'video' },
        { id: 38, title: 'Criação de Públicos I', duration: '90 min', type: 'video' },
        { id: 39, title: 'Criação de Públicos II', duration: '90 min', type: 'video' },
        { id: 40, title: 'Criação de Públicos III', duration: '90 min', type: 'video' },
        { id: 41, title: 'Gerenciador de Anúncios', duration: '90 min', type: 'video' },
        { id: 42, title: 'Criação de Campanha I', duration: '90 min', type: 'video' },
        { id: 43, title: 'Criação de Campanha II', duration: '90 min', type: 'video' },
        { id: 44, title: 'Criação de Campanha III', duration: '90 min', type: 'video' },
        { id: 45, title: 'Criação de Campanha IV', duration: '90 min', type: 'video' },
        { id: 46, title: 'Publicando Campanhas', duration: '90 min', type: 'video' },
        { id: 47, title: 'Leads e Pixel (Ferramentas de Conversão)', duration: '90 min', type: 'video' },
        { id: 48, title: 'Gerando e Analisando Dados', duration: '90 min', type: 'video' },
      ],
    }
  ],
  ...
  curriculum: [
    ...
    },
    {
      ...
      lessons: [
        ...
        { id: 24, title: 'Refatoração e revisão assistida por IA', duration: '90 min', type: 'video' },
        { id: 25, title: 'Boas práticas para acelerar projetos com Cursor', duration: '90 min', type: 'video' },
      ],
    },
    {
      id: 4,
      ...
      lessons: [
        ...
        { id: 28, title: 'Construindo mecânicas com blocos', duration: '90 min', type: 'video' },
        { id: 29, title: 'Publicação e testes de jogo no Flowlabs', duration: '90 min', type: 'project' },
      ],
    },
    {
      id: 5,
      ...
      lessons: [
        ...
        { id: 32, title: 'Ajustes de tom, ritmo e naturalidade', duration: '90 min', type: 'video' },
        { id: 33, title: 'Aplicações práticas em vídeos, aulas e podcasts', duration: '90 min', type: 'video' },
      ],
    },
    {
      id: 6,
      ...
      lessons: [
        ...
        { id: 36, title: 'Criação de layouts e protótipos rápidos', duration: '90 min', type: 'video' },
        { id: 37, title: 'Apresentação de projetos com apoio visual', duration: '90 min', type: 'project' },
      ],
    }
  ],
...
const businessIntelligence = {
  ...
  curriculum: [
    ...
    },
    {
      ...
      description: 'Uso de IA para explorar dados, gerar insights e acelerar a construção de dashboards',
      duration: '6 horas',
      note: 'Conteúdo provisório para apresentação da estrutura do módulo em produção',
      lessons: [
        { id: 37, title: 'Introdução à IA para análise de dados', duration: '90 min', type: 'video' },
        { id: 38, title: 'Geração de insights e leitura de indicadores com IA', duration: '90 min', type: 'video' },
        { id: 39, title: 'Apoio de IA na estruturação de dashboards', duration: '90 min', type: 'video' },
        { id: 40, title: 'Projeto guiado: dashboard com apoio de IA', duration: '90 min', type: 'project' },
      ],
    }
  ],
