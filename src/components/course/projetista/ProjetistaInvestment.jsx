          ...
          <div className="relative rounded-2xl bg-zinc-800/50 backdrop-blur p-8 border border-zinc-700/50 transition-all duration-300 hover:border-purple-500/50 hover:shadow-2xl hover:shadow-purple-500/10">
            ...
            <div className="text-center mb-8">
              <div className="flex items-center justify-center gap-4 mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-lg md:text-2xl text-red-400 line-through">DE: R$ 6.126,00</span>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-2 mb-6">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-2xl md:text-4xl font-bold text-green-400 whitespace-nowrap">POR: R$ 3.493,00</span>
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="text-center p-4 md:p-6 bg-zinc-700/30 rounded-lg border border-zinc-600">
                ...
                <div className="text-lg md:text-2xl font-bold text-cyan-400 mb-2">7x de R$ 499,00</div>
              ...
              <div className="text-center p-4 md:p-6 bg-green-500/10 rounded-lg border border-green-400/20">
                ...
                <div className="text-lg md:text-2xl font-bold text-green-400 mb-2">R$ 3.143,70</div>
