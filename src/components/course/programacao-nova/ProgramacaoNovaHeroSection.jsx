...
export const ProgramacaoNovaHeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-950">
      ...
      <div className="absolute inset-0">
        <img
          src="/assets/programacao-nova/hero/1318912.png"
          alt="Curso de Programação Background"
      ...
      <div className="absolute top-1/4 left-2 sm:left-1/4 w-40 h-40 sm:w-64 md:w-80 lg:w-96 sm:h-64 md:h-80 lg:h-96 bg-purple-500/20 rounded-full blur-2xl md:blur-3xl animate-pulse" />
      <div className="absolute bottom-1/4 right-2 sm:right-1/4 w-32 h-32 sm:w-56 md:w-64 lg:w-80 sm:h-56 md:h-64 lg:h-80 bg-blue-400/20 rounded-full blur-2xl md:blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
          ...
          <span className="block text-2xl md:text-3xl mt-4 text-blue-300 font-semibold">
        ...
        <p className="text-xl md:text-2xl text-gray-300 mb-6 max-w-4xl mx-auto leading-relaxed">
          <span className="font-semibold text-white">Python, JavaScript, HTML/CSS</span>, Git e{' '}
        ...
        <div className="flex flex-wrap justify-center gap-2 sm:gap-3 mb-6">
          ...
          >
            <Users className="w-3 h-3 sm:w-4 sm:h-4 mr-1.5 text-purple-400" />
          ...
          >
            <Brain className="w-3 h-3 sm:w-4 sm:h-4 mr-1.5 text-blue-400" />
            <span className="text-xs sm:text-sm">Python + IA</span>
          </Badge>
        </div>
        ...
        <p className="text-sm sm:text-base text-zinc-400 text-center mb-8">
          ...
          <span className="text-blue-400 font-semibold">São José</span>,{' '}
          <span className="text-blue-400 font-semibold">Florianópolis</span>,{' '}
          <span className="text-blue-400 font-semibold">Palhoça</span> e{' '}
          <span className="text-blue-400 font-semibold">Biguaçu</span>
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
          <button
            ...
            className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-purple-600 to-blue-600 text-white font-semibold rounded-full hover:from-purple-700 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl group cursor-pointer"
          >
