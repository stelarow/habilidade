...
const BlogContactSection = ({ 
  ...
  const handleEmailClick = () => {
    const subject = article 
      ? `Interesse ap�s ler: ${article.title}`
    ...
    <div className={`bg-gradient-to-br from-zinc-900 via-purple-900/10 to-zinc-900 border border-purple-500/20 rounded-2xl p-8 ${className}`}>
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-zinc-300 text-lg max-w-2xl mx-auto">
          {article 
            ? `Que tal dar o pr�ximo passo? Converse conosco sobre como nossos cursos podem ajudar voc� a se especializar em ${category?.name || 'sua �rea de interesse'}.`
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        >
          ...
          <p className="text-zinc-400 text-sm">
            Converse diretamente conosco pelo WhatsApp. Resposta r�pida e personalizada!
          </p>
        </button>
        ...
        >
          ...
          <p className="text-zinc-400 text-sm">
            Ligue diretamente para esclarecer d�vidas e receber orienta��es personalizadas.
          </p>
        </button>
        ...
        >
          ...
          <p className="text-zinc-400 text-sm">
            Envie um email com suas d�vidas e receba informa��es detalhadas sobre os cursos.
          </p>
        </button>
      </div>
      ...
      <div className="text-center text-sm text-zinc-400 border-t border-zinc-700 pt-4">
        <p>
          ...
          <br />
          =� Email: {EMAIL_CONFIG.CONTACT_EMAIL}
          <br />
