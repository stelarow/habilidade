...
export const ABTestBlogLayout = ({ posts }) => {
  ...
  useEffect(() => {
    // Track que o usu�rio viu esta variante
...
export const ABTestCTAPlacement = ({ content, postSlug }) => {
  ...
  switch (variant.placement) {
    ...
    case 'inline': {
      // Insere CTA no meio do conte�do
...
/**
 * Exemplo de uso do A/B testing para posi��o da barra de pesquisa
 */
...
/**
 * Exemplo de uso do A/B testing para navega��o de categorias
 */
...
/**
 * Hook para facilitar tracking de m�tricas personalizadas
 */
...
// Exemplo de uso completo em uma p�gina de blog
