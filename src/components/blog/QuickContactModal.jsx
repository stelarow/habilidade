    ...
    try {
      ...
      if (selectedMethod === 'email' || selectedMethod === 'consultation') {
        ...
        const templateParameters = {
          ...
          article: article?.title || 'N�o especificado',
          category: category?.name || category || 'N�o especificado',
      ...
      <div className="relative w-full max-w-md bg-zinc-900 rounded-2xl border border-zinc-700 shadow-2xl">
            ...
            <div className="space-y-3">
              ...
              <div className="border-t border-zinc-700 pt-3 mt-4">
                <p className="text-zinc-400 text-sm text-center mb-3">
                  Ou preencha um formul�rio r�pido:
                </p>
        ...
        {step === 2 && (
          <div className="p-6">
            <div className="text-center mb-6">
              <h3 className="text-xl font-bold text-white mb-2">
                {selectedMethod === 'consultation' ? 'Agendar Consulta' : 'Formul�rio de Contato'}
              </h3>
              <p className="text-zinc-300 text-sm">
          ...
          <div className="p-6 text-center">
            <div className="mb-4">
              ...
              <p className="text-zinc-300">
                {selectedMethod === 'consultation' 
                  ? 'Sua solicita��o de consulta foi enviada. Entraremos em contato em breve para confirmar o hor�rio.'
                  : (selectedMethod === 'whatsapp'
                  ? 'Voc� ser� redirecionado para o WhatsApp com sua mensagem preparada.'
