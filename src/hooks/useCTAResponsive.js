/**
 * useCTAResponsive Hook - Hook para otimiza��es responsivas de CTAs
 * Gerencia comportamento espec�fico para diferentes dispositivos
 */
...
export const useCTAResponsive = (options = {}) => {
  const {
    ...
    enableSticky = true,
    stickyThreshold = 0.8, // 80% da p�gina scrollada
  ...
  // Configura��es espec�ficas por dispositivo
...
/**
 * Hook para otimiza��es de performance de CTAs
 */
...
export const useCTAImages = (images = {}) => {
  ...
  const getOptimalImage = useCallback((imageSet) => {
    ...
    // Se � uma string simples, retorna ela
...
export const useCTAVariant = (testConfig = {}) => {
  ...
  const [currentVariant, setCurrentVariant] = useState(() => {
    // Se h� uma variante for�ada, use ela
    ...
    // Seleciona aleatoriamente baseado na distribui��o
