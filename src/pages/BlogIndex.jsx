...
// SSG loader function - direct Supabase import to avoid circular dependencies
export async function loader() {
  ...
  if (typeof window === 'undefined') {
    try {
      ...
      // Fetch posts with simplified query to reduce complexity
      ...
      // Transform posts data with safer property access
      ...
      const categories = (categoriesData || []).map(category => ({
        ...
        postCount: 0 // Will be populated by client-side if needed
      }));
      
      console.log(`SSG Blog: Fetched ${posts.length} posts and ${categories.length} categories`);
      ...
      // Return empty data but don't fail the build
      return { 
        initialPosts: [], 
        initialCategories: [],
        totalPosts: 0,
