...
export const getBusinessHoursStatus = () => {
  try {
    ...
    if (isOpen) {
      ...
      message = hoursUntilClose <= 1 ? `=� Online agora (fecha em ${Math.round(hoursUntilClose * 60)} minutos)` : `=� Online agora - Resposta imediata`;
...
export const getBusinessHoursString = () => {
  return 'Segunda a sexta, das 8h �s 18h';
};
