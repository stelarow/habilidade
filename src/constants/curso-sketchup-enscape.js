// Constants file for SketchUp + Enscape course page
// All static data externalized for performance optimization

// SketchUp lessons data
export const SKETCHUP_LESSONS = Object.freeze([
...
// Enscape lessons data
export const ENSCAPE_LESSONS = Object.freeze([
...
// Companies data
export const COMPANIES_DATA = Object.freeze([
  {
    name: "Portinox",
...
// Testimonials data
export const TESTIMONIALS_DATA = Object.freeze([
  {
    name: "Jonatas Torres",
    initials: "JT",
...
export const ANIMATION_VARIANTS = Object.freeze({
  ...
  hoverLift: {
    hover: { y: -5, boxShadow: "0 10px 30px rgba(212, 0, 255, 0.15)" }
  }
});

// Course statistics
export const COURSE_STATS = Object.freeze({
  totalHours: "56h",
  practicalLessons: "28",
  completeProjects: "6"
});
...
export const PRICING_INFO = Object.freeze({
  originalPrice: "R$ 4.655,00",
  discountPrice: "R$ 2.793,00", 
  installmentPrice: "R$ 279,30",
  installments: 10,
  whatsappNumber: "5548988559491"
});

// Contact information
export const CONTACT_INFO = Object.freeze({
  phone: "(48) 98855-9491",
  whatsapp: "5548988559491",
  address: {
    street: "R. Caetano José Ferreira, 426",
    complement: "Sala 5 - Kobrasol",
    city: "São José - SC, 88102-280"
  }
});
...
// Statistics for companies section
export const COMPANIES_STATS = Object.freeze([
...
export const PRICING = Object.freeze({
  original: "R$ 4.655,00",
  discount: "R$ 2.793,00",
  installment: "R$ 279,30",
  installments: 10
});

export const HERO_IMAGES = Object.freeze([
  "/assets/cursos/sketchup-enscape/render-1.jpeg",
  "/assets/cursos/sketchup-enscape/render-2.jpeg",
  "/assets/cursos/sketchup-enscape/render-3.jpeg",
  "/assets/cursos/sketchup-enscape/render-4.jpeg"
]);

export const COURSE_FEATURES = Object.freeze([
  {
    icon: "Box",
    title: "Modelagem 3D",
    description: "Domine todas as ferramentas do SketchUp para criar modelos 3D precisos e detalhados."
  },
  {
    icon: "Lightbulb", 
    title: "Renderização",
    description: "Crie imagens fotorrealísticas com Enscape, incluindo iluminação e materiais profissionais."
  },
  {
    icon: "Target",
    title: "Projetos Reais",
    description: "Desenvolva projetos completos: residências, interiores e documentação técnica."
  }
]);

export const COURSE_PROJECTS = PROJECTS_DATA;

export const QUICK_BENEFITS = Object.freeze([
  "Certificação profissional",
  "6 projetos completos", 
  "Suporte vitalício"
]);

export const COMPANY_STATS = COMPANIES_STATS;

export const COURSE_MODULES = Object.freeze([
  {
    title: "SketchUp - Modelagem 3D",
    icon: "Box",
    lessons: SKETCHUP_LESSONS
  },
  {
...
export const SEO_DATA = Object.freeze({
  title: "Curso SketchUp + Enscape - Do Esboço ao Render | Escola Habilidade",
  description: "Domine SketchUp + Enscape para criar projetos arquitetônicos profissionais com renderizações fotorealísticas. 56h de curso, 28 aulas práticas, 6 projetos completos. Aulas presenciais em São José/SC.",
  keywords: "curso sketchup, curso enscape, renderização 3d, arquitetura, design, são josé sc, escola habilidade",
  image: "/assets/cursos/sketchup-enscape/architectural-render-bg.jpeg",
  canonical: "https://escolahabilidade.com/cursos/sketchup-enscape"
});